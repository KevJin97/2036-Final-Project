...
Game::Game() :
        m_window(sf::VideoMode(2560, 1440), "Game")
{
    //load the player
    //m1_player.load("Mario.png");
	map.load("/Users/Jin/source/repos/2036_final_project/build/Map.jpg");
	r1.load("/Users/Jin/source/repos/2036_final_project/build/ChiefShip.png");
	r2.load("/Users/Jin/source/repos/2036_final_project/build/Hunter.png");
	crate.load("/Users/Jin/source/repos/2036_final_project/build/Crates.png");
	m2_player.load("/Users/Jin/source/repos/2036_final_project/build/MasterChiefOriginal1.png", sf::IntRect(startHalo, 0, widthHalo, heightHalo));
	m3_player.load("/Users/Jin/source/repos/2036_final_project/build/Covenant1.png", sf::IntRect(startCov, 0, widthCov, heightCov));
	dancer.load("/Users/Jin/source/repos/2036_final_project/build/ChiefDance.png", sf::IntRect(startXDance, startYDance, widthDance, heightDance));
	shot.load("/Users/Jin/source/repos/2036_final_project/build/shot2.png", sf::IntRect(0, 0, 0, 0));
	shot2.load("/Users/Jin/source/repos/2036_final_project/build/shot5.png", sf::IntRect(0, 0, 0, 0));


    m2_player.setPosition(50.0f,200.0f);
    m3_player.setPosition(400.0f,200.0f);
